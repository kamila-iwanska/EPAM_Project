...
function initializeProductView() {
    ...
    const rawId = (_a = searchParams.get('id')) !== null && _a !== void 0 ? _a : '';
    const product = (_b = getProductById(rawId)) !== null && _b !== void 0 ? _b : getProductById('SU001');
    // PRODUCT INFO
    ...
    // SUBMITTING A REVIEW
    const reviewFormEl = document.getElementById('product-review-form');
    ...
    const recommendedTemplateEl = document.getElementById('product-recommended-template');
    const products = getProductsForBlock('You May Also Like');
    for (const product of products) {
        const productEl = recommendedTemplateEl.content.cloneNode(true);
        ...
        const productImageEl = productEl.querySelector('.recommended-image');
        productImageEl.src = product.imageUrl;
        productImageEl.alt = product.imageUrl;
