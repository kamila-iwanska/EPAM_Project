...
function initializeCatalogView() {
    ...
    const topSetsTemplateEl = document.getElementById('catalog-top-sets-template');
    const topSets = getProductsFromCategory('luggage sets');
    for (const topSet of topSets) {
        const topSetEl = topSetsTemplateEl.content.cloneNode(true);
        ...
        const topSetImageEl = topSetEl.querySelector('.catalog-top-set-image');
...
function render() {
    ...
    const productsTemplateEl = document.getElementById('catalog-products-template');
    productsEl.innerHTML = '';
    for (const product of items) {
        const productEl = productsTemplateEl.content.cloneNode(true);
        const productImageEl = productEl.querySelector('.catalog-product-image');
